<!-- Main content -->
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <div class="box-header" style="background-color: rgba(19, 17, 17, 0.21);">
                  ...
                  <h3 class="box-title">1st Tile</h3>
      ...
      <?php }?>
      <?php if( !empty($data) ){?>
					<form  action="<?php echo base_url()?>admin/HomePartner/updatePartner/" method="post" enctype="multipart/form-data">
  ...
  <div id="thumbs">
    <?php if( !empty(json_decode($data[0]['images']))  ){ $i=0;?>
      <?php foreach(json_decode($data[0]['images']) as $key => $value) {?>
        <img src="<?php echo base_url()?>assets/img/home/partner/<?php echo $value ?>" alt="1st image description" style="width: 150px;margin:5px;" />
    ...
    <div class="form-group">
                      ...
                      <textarea id="editor1" name="desc" cols="3" rows="2" required><?php echo isset($data[0]['description'])?$data[0]['description']:''?></textarea>
